...
enum class EDropfallObstacle : uint8 { Block, Pillar, Ramp };
...
struct FDropfallMapDefinition
{
    ...
    static constexpr float DropInterval = 14;
    ...
    FVector Spawn(bool bCyan) const { return FVector((bCyan ? 1 : -1) * (HalfSize().X - 170), 0, 110); }
    int32 RingAt(FVector2D Position) const;
