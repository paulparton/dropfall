...
import { getThemeMaterials, getThemeColors, getThemeShaderMaterials } from '../utils/themeTextures';
import { resolveThemeName } from '../shaders/index';
...
export class Arena extends EntityBase implements ArenaEntity {
  ...
  private _initialize(): void {
    ...
    // Create shader-based skybox material
